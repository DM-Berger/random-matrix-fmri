...
% Conclusions
% Predictive modeling of lumbar spine surgery outcomes was improved by incorporation of
...
\begin{abstract}
\section*{Purpose}
Random matrix theory (RMT) is increasingly becoming a useful tool for understanding complex systems.
Prior studies have examined functional Magnetic Resonance Imaging (fMRI) images using tools from
RMT, with some success. However, RMT computations are complex, and sensitive to numerous analytic
choices. We systematically investigate the usefulness of RMT in a variety of fMRI datasets.
