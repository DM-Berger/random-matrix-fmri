...
summarize patterns of results across two abstract levels of feature
groupings—"coarse", and "fine"—shown in Table \ref{tab:features}.

Finally, it makes sense to exclude classification tasks or an analytic factor
...
distributions in any case (Figure S\ref{S-fig:fine-trim}).   While there was no
clearly observable differences between the mAUROC distributions depending on
whether
