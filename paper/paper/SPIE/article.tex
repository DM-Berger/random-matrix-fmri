...
\subsection{Normalization}
There was no visible effect of normalization on mAUROC distributions at any
summary level.
...
Features were most predictive when using either the largest 5 or 10\% or middle
