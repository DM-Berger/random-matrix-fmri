...
If RMT- or eigenvalue-based features fail to outperform features that are simple
summary statistics of the fMRI data in predictive utility, it is difficult to
justify the greater computational and interpretational complexities of the
former. We compute ten simple statistical reductions of the voxel time series
("timeseries features") to help assess the relative value of RMT features.
